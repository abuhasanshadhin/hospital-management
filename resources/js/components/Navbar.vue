<template>
  <div>
    <nav
      class="navbar navbar-expand navbar-light bg-white topbar mb-4 sticky-top shadow"
    >
      <!-- Topbar Navbar -->
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
          <a
            ...
            @click="showAlertDropdown = !showAlertDropdown"
          >
          ...
          <div
            ...
            v-on-clickaway="() => (showAlertDropdown = false)"
          >
        ...
        <li class="nav-item dropdown no-arrow mx-1">
          ...
          <div
            ...
            v-on-clickaway="() => (showMessageDropdown = false)"
          >
        ...
        <li class="nav-item dropdown no-arrow">
          ...
          <div
            ...
            v-on-clickaway="() => (showUserDropdown = false)"
          >
